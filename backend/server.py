...
def Albania():
        ...
        articlePath = "//div[@class='block-content']//div[@class='article-content']//a"
        paragraphPath = "//div[@class='column9']//p"
...
def Australia():
        ...
        articlePath = "//div[@data-id='latest-feed']//article//h3/a"
        paragraphPath = "//div[contains(@class, 'article__body')]//div[@class='block-content']"
        return summarise(getGeneralCountry(driver=driver, website=website, articlePath=articlePath, paragraphPath=paragraphPath))

@app.route("/Austria")
def Austria():
        website = "https://www.oe24.at/"
        articlePath = "(//div[@class='oneColumne'])[1]/a| (//div[@class='threeColumne'])[1]/a"
        paragraphPath = "//div[contains(@class, 'bodyText')]//p"
        return summarise(getGeneralCountry(driver=driver, website=website, articlePath=articlePath, paragraphPath=paragraphPath))
...
@app.route("/Barbados")
def Barbados():
        website = "https://barbadostoday.bb/"
        articlePath = "//div[contains(@class, 'penci-biggrid-inner')]//h3/a"
...
def Belarus():
        ...
        articlePath = "//div[@class='main_news1']/a[1] | //div[@class='main_news2']/div/a[1]"
        paragraphPath = "//div[contains(@class, 'js-mediator-article')]//div"
        return summarise(getGeneralCountry(driver=driver, website=website, articlePath=articlePath, paragraphPath=paragraphPath))

@app.route("/Belgium")
def Belgium():
        website = "https://www.vrt.be/vrtnws/en/"
        articlePath = "(//div[@data-sentry-component='DynamicGrid']//ul)[position() <= 5]//li//a"
        paragraphPath = "//div[contains(@class, 'cmp-text')]//p"
        return summarise(getGeneralCountry(driver=driver, website=website, articlePath=articlePath, paragraphPath=paragraphPath))
...
@app.route("/Brazil")
def Brazil():
        website = "https://www1.folha.uol.com.br/internacional/en/"
        articlePath = "(//div[@class='flex-cell'])[1]//div[@class='c-headline__content']/a"
        paragraphPath = "//div[contains(@class, 'c-news__content')]//p"
        return summarise(getGeneralCountry(driver=driver, website=website, articlePath=articlePath, paragraphPath=paragraphPath))
...
def Czech_Republic():
        website = "https://english.radio.cz/"
        articlePath = "(//div[contains(@class, 'item-first')])[1]//h3//a"
        paragraphPath = "//div[@class='field body']//p"
        return summarise(getGeneralCountry(driver=driver, website=website, articlePath=articlePath, paragraphPath=paragraphPath))
...
def Dem_Rep_Korea():
        website = "https://www.dailynk.com/english/"
        articlePath = "//div[@id='tdi_39']//h3/a"
...
def Ecuador():
        ...
        articlePath = "(//div[contains(@class, 'chain-section')])[4]//h2/a"
        paragraphPath = "//section[contains(@class, 'article-body')]//p"
        return summarise(getGeneralCountry(driver=driver, website=website, articlePath=articlePath, paragraphPath=paragraphPath))
...
@app.route("/Guyana")
def Guyana():
        website = "https://www.kaieteurnewsonline.com/"
        articlePath = "//div[@id='custom-recent-posts-grid-list-2']//div[@class='post-title']//a"
...
@app.route("/Iceland")
def Iceland():
        website = "https://icelandmonitor.mbl.is/news/"
        articlePath = "(//div[contains(@class, 'd--teaser-poster')]/a)[position() <= 7]"
        paragraphPath = "//div[@class='ni-main']//p"
        return summarise(getGeneralCountry(driver=driver, website=website, articlePath=articlePath, paragraphPath=paragraphPath))

@app.route("/India")
def India():
        website = "https://www.ndtv.com/"
        articlePath = "//div[contains(@class, 'vjl2_Lhs')]//div[contains(@class, 'mb-25')]//h3/a | //div[contains(@class, 'vjl2_Lhs')]//div[contains(@class, 'mb-25')]//h1/a"
        paragraphPath = "//div[@class='Art-exp_wr']//p"
        return summarise(getGeneralCountry(driver=driver, website=website, articlePath=articlePath, paragraphPath=paragraphPath))

@app.route("/Indonesia")
def Indonesia():
        website = "https://www.kompas.com/"
        articlePath = "(//div[@id='mostLayout1']/div/a)[position() <= 5]"
        paragraphPath = "//div[@class='read__content']//p"
        return summarise(getGeneralCountry(driver=driver, website=website, articlePath=articlePath, paragraphPath=paragraphPath))

@app.route("/Iran")
def Iran():
        website = "https://kayhan.ir/"
        articlePath = "//div[contains(@class, 'linear_news')]//h2//a"
...
def Japan():
        ...
        articlePath = "//div[contains(@class, 'category_parts_a')]//ul/li/a"
        paragraphPath = "//div[contains(@id, 'p-article-block')]//p"
        return summarise(getGeneralCountry(driver=driver, website=website, articlePath=articlePath, paragraphPath=paragraphPath))

@app.route("/Jordan")
def Jordan():
        website = "https://www.addustour.com/"
        articlePath = "//div[@class='news-theme']//div[contains(@class, 'sectionHero_elements')]/a"
        paragraphPath = "//div[@id='body-text']//p"
        return summarise(getGeneralCountry(driver=driver, website=website, articlePath=articlePath, paragraphPath=paragraphPath))

@app.route("/Kazakhstan")
def Kazakhstan():
        website = "https://astanatimes.com/"
        articlePath = "//div[@class='wco-items']//h3/a | //div[@class='wco-items']//h4/a"
        paragraphPath = "//div[@class='post']//p"
        return summarise(getGeneralCountry(driver=driver, website=website, articlePath=articlePath, paragraphPath=paragraphPath))
...
@app.route("/Kosovo")
def Kosovo():
        website = "https://kosovapress.com/en/"
        articlePath = "//div[@class='bx-viewport']//div[@class='mainNewsCntBS']/a[1]"
        paragraphPath = "//div[@class='descDivView']//p"
        return summarise(getGeneralCountry(driver=driver, website=website, articlePath=articlePath, paragraphPath=paragraphPath))

@app.route("/Kuwait")
def Kuwait():
        website = "https://kuwaittimes.com/kuwait/"
        articlePath = "//div[@class='kt-widget-article-one-and-six-category ']//h2/a"
...
def Laos():
        ...
        articlePath = "//div[@id='tdi_55']//h3/a"
        paragraphPath = "//div[contains(@class, 'tdb_single_content')]//p"
        return summarise(getGeneralCountry(driver=driver, website=website, articlePath=articlePath, paragraphPath=paragraphPath))
...
def Lebanon():
        ...
        articlePath = "//div[@class='column-1']//article//h2/a | //div[@class='column-2']//article//h2/a | //p[@class='title']/a"
        paragraphPath = "//div[contains(@class, 'entry-content')]//p"
        return summarise(getGeneralCountry(driver=driver, website=website, articlePath=articlePath, paragraphPath=paragraphPath))
...
def Malaysia():
        ...
        articlePath = "//div[@class='story-set']//h2/a | (//div[@class='focus-story']//h2/a)[position() <= 1]"
        paragraphPath = "//div[@id='story-body']//p"
        return summarise(getGeneralCountry(driver=driver, website=website, articlePath=articlePath, paragraphPath=paragraphPath))

@app.route("/Maldives")
def Maldives():
        website = "https://maldivesindependent.com/"
        articlePath = "(//main/div)[1]/a | (//main/div)[2]/div[1]/div/a"
        paragraphPath = "//div[@class='flex flex-col ']//p"
        return summarise(getGeneralCountry(driver=driver, website=website, articlePath=articlePath, paragraphPath=paragraphPath))
...
@app.route("/Myanmar")
def Myanmar():
        website = "https://www.irrawaddy.com/"
        articlePath = "//article[contains(@class, 'jeg_pl_md_5')]//h3//a | //div[contains(@class, 'elementor-widget-jnews_block_16_elementor')]//h3//a"
        paragraphPath = "//div[contains(@class, 'entry-content')]//p"
        return summarise(getGeneralCountry(driver=driver, website=website, articlePath=articlePath, paragraphPath=paragraphPath))
...
def Norway():
        ...
        articlePath = "//div[@id='tdi_52']//h3/a | //div[@id='tdi_53']//h3/a"
        paragraphPath = "//div[contains(@class, 'tdb-block-inner')]//p"
        return summarise(getGeneralCountry(driver=driver, website=website, articlePath=articlePath, paragraphPath=paragraphPath))
...
@app.route("/Palau")
def Palau():
        website = "https://islandtimes.org/"
        articlePath = "(//article[contains(@class, 'category-top-stories')]//h2/a)[position() <= 10]"
        paragraphPath = "//div[@class='entry-content']//p"
        return summarise(getGeneralCountry(driver=driver, website=website, articlePath=articlePath, paragraphPath=paragraphPath))
...
def Philippines():
        ...
        articlePath = "//div[@class='mb-font-article-title']/a"
        paragraphPath = "//div[contains(@class, 'custom-article-body mb-font-article-body')]//p"
        return summarise(getPhilippines(driver=driver, website=website, articlePath=articlePath, paragraphPath=paragraphPath))
...
@app.route("/Portugal")
def Portugal():
        website = "https://www.cmjornal.pt/portugal"
        articlePath = "//div[@class='coluna_noticias']//article//div[@class='text_container']/a"
        paragraphPath = "//section[@class='corpo_noticia']//p"
        return summarise(getGeneralCountry(driver=driver, website=website, articlePath=articlePath, paragraphPath=paragraphPath))
...
def Romania():
        ...
        articlePath = "(//div[contains(@class, 'region-front-page-content-2')]//div[contains(@class, 'views-field-field-title')]//div[@class='field-content']/a)[position() <= 6]"
        paragraphPath = "//div[contains(@class, 'field--type-text-with-summary')]//p"
        return summarise(getGeneralCountry(driver=driver, website=website, articlePath=articlePath, paragraphPath=paragraphPath))

@app.route("/Russia")
def Russia():
        website = "https://www.themoscowtimes.com/news"
        articlePath = "//section[contains(@class, 'cluster--section-articles')]//div/div/a"
        paragraphPath = "//div[@class='article__content']//p"
        return summarise(getGeneralCountry(driver=driver, website=website, articlePath=articlePath, paragraphPath=paragraphPath))
...
@app.route("/Serbia")
def Serbia():
        website = "https://www.danas.rs/"
        articlePath = "//div[contains(@class, 'lg:w-5/12')]//h3[@class='article-post-title']/a | //div[contains(@class, 'lg:w-4/12')]//article[contains(@class, 'post-img-right-without-excerpt')]//h3[@class='article-post-title']/a"
        paragraphPath = "//div[contains(@class, 'post-content')]//div[@class='w-full md:w-10/12']/p"
        return summarise(getGeneralCountry(driver=driver, website=website, articlePath=articlePath, paragraphPath=paragraphPath))
...
@app.route("/Singapore")
def Singapore():
        website = "https://www.straitstimes.com/singapore"
        articlePath = "//div[@class='content']//div[contains(@class, 'a-1-8')]//h5/a"
        paragraphPath = "//section[@class='article-content']//p[@class='paragraph-base']"
        return summarise(getGeneralCountry(driver=driver, website=website, articlePath=articlePath, paragraphPath=paragraphPath))
...
@app.route("/Spain")
def Spain():
        website = "https://www.elmundo.es/espana.html"
        articlePath = "//div[@class='ue-l-cg']//article//header//a"
        paragraphPath = "//div[@class='ue-c-article__body']//p"
        return summarise(getGeneralCountry(driver=driver, website=website, articlePath=articlePath, paragraphPath=paragraphPath))
...
@app.route("/Suriname")
def Suriname():
        website = "https://www.surinametimes.com/binnenland"
        articlePath = "//div[@class='article-grid_grid__0iFT4']/div/a"
        paragraphPath = "//div[@class='article_content__filEj']//p"
        return summarise(getGeneralCountry(driver=driver, website=website, articlePath=articlePath, paragraphPath=paragraphPath))

@app.route("/Sweden")
def Sweden():
        website = "https://www.thelocal.se/"
        articlePath = "//div[@data-source='latest']//article/a"
        paragraphPath = "//div[contains(@class, 'article-single__content')='articleBody']//p"
        return summarise(getGeneralCountry(driver=driver, website=website, articlePath=articlePath, paragraphPath=paragraphPath))
...
def Tajikistan():
        website = "https://avesta.tj/"
        articlePath = "//div[contains(@class, 'tns-slide-active')]//h2/a | (//div[@class='jeg_block_container'])[2]//h3/a"
        paragraphPath = "//div[contains(@class, 'entry-content with-share')]//p"
        return summarise(getGeneralCountry(driver=driver, website=website, articlePath=articlePath, paragraphPath=paragraphPath))
...
def Thailand():
        ...
        articlePath = "(//div[contains(@class, 'owl-carousel')])[1]//div[@class='owl-item']//h3/a | (//div[contains(@class, 'owl-carousel')])[1]//div[@class='owl-item active']//h3/a"
        paragraphPath = "//div[@class='article-content']//p"
        return summarise(getGeneralCountry(driver=driver, website=website, articlePath=articlePath, paragraphPath=paragraphPath))

@app.route("/Timor-Leste")
def Timor_Leste():
        website = "https://en.tatoli.tl/"
        articlePath = "//div[@id='mobile-slider']//div[@class='slider-item']//h4//a | //div[@id='mobile-slider']//div[@class='slider-item flex-active-slide']//h4//a"
        paragraphPath = "//div[contains(@class, 'post-content')]//p"
        return summarise(getGeneralCountry(driver=driver, website=website, articlePath=articlePath, paragraphPath=paragraphPath))
...
def United_Arab_Emirates():
        website = "https://www.khaleejtimes.com/uae"
        articlePath = "//div[contains(@class, 'sec-order-0')]//h4/a"
        paragraphPath = "//div[contains(@class, 'article-center-wrap-nf')]//p"
        return summarise(getGeneralCountry(driver=driver, website=website, articlePath=articlePath, paragraphPath=paragraphPath))

@app.route("/United Kingdom")
def United_Kingdom():
        website = "https://www.bbc.co.uk/news/uk"
        articlePath = "//div[contains(@class, 'ssrcss-yawlqh-GridWrapper')]//div[@spacing='2']/a"
        paragraphPath = "//article//p"
        return summarise(getGeneralCountry(driver=driver, website=website, articlePath=articlePath, paragraphPath=paragraphPath))
...
@app.route("/Vanuatu")
def Vanuatu():
        website = "https://www.dailypost.vu/news/"
        articlePath = "(//div[@id='tncms-block-1255588']//article//h3/a)[position() <= 10] | //div[@id='tncms-block-1255585']//article//h2/a"
...
def Vietnam():
        ...
        articlePath = "//div[@class='l-content']//div[@class='slick-track']/div/a"
        paragraphPath = "//div[@id='abody']//p"
        return summarise(getGeneralCountry(driver=driver, website=website, articlePath=articlePath, paragraphPath=paragraphPath))
...
@app.route("/Yemen")
def Yemen():
        website = "https://www.yemenonline.info/"
        articlePath = "//div[@class = 'post_gallery_play slick-slide']//h2//a | //div[@class = 'post_gallery_play slick-slide slick-current slick-active']//h2//a"
        paragraphPath = "//div[contains(@class, 'post-text')]//p"
        return summarise(getGeneralCountry(driver=driver, website=website, articlePath=articlePath, paragraphPath=paragraphPath))
